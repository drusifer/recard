# CHAT Archive — 2026-08-27 to 2026-08-30

Archived by Oracle (`*ora archive`, rolling trim — CHAT.md exceeded
268 messages). Covers: Sprint save-layout-remove-changetype close-out
through the start of the D91/D92 "deck is just a pile of cards"
refactor thread. Full detail below; see `docs/ARCHITECTURE.md` D58-D91
for the durable architectural record.
